import { Center, Image, Pressable, Modal, IconButton, CloseIcon, Row  } from 'native-base';
    ...
    return <Box  style={styles.cBox}>
        <Modal isOpen={show} onClose={() => setShow(false)} background='#330F0Cbb'>
            <Modal.Content background='transparent' borderWidth={0}>
                ...
                <Image source={card}  width={300} height={442} />
                <Box  position='absolute' top={0} width='100%'>
                    <Center>
                        <Text marginTop='146px' color='#FFD5AE' fontSize={15} bold>Obter bônus em dinheiro</Text>
                        <Row height='80px' marginTop={3} alignItems='flex-end'>
                            <Text color='#FFD5AF' bold>R$</Text>
                            <Text color='#FFD5AF' bold fontSize={68} lineHeight={68}>68</Text>
                            <Box height='100%'>
                        ...
                        <Text marginTop='68px' color='#FFD5AE' marginLeft={10} bold>Tempo efetivo：10 min</Text>
                        <Pressable marginTop='32px'  onPress={() => {
                            Linking.openURL(BaseUrl.downloadAndroid);
                        }}>
                            <Center >
                                <Image source={cardBtn}  width={220} height='40px' />
                                <Box position='absolute'>
                                    <Text  color='#854600' fontSize={14} bold>Faça login para receber</Text>
                                </Box>
                            </Center>
                        </Pressable>
                    </Center>
            ...
            <Center marginTop={4} >
                <Pressable  onPress={() => {
                    ...
                    <Image source={closeBtn}  width={36} height={36} />
                </Pressable>
            </Center>
        </Modal>
        <Box  >
            <Pressable onPress={() => {
                ...
                <Center >
                    <Image source={chest}  width='52px' height='60px' />
                    <Animated.View style={[styles.box1]}>
                        <Animated.Image source={coin2} style={[
                            styles.image1,
                            {
                                top: topAnim,
                            }
                    ...
                    <Animated.View style={[styles.box2]}>
                        <Animated.Image source={coin1} style={[
                            styles.image2,
                            {
                                top: topAnim,
                            }
                    ...
                    <Animated.View style={[styles.box3]}>
                        <Animated.Image source={coin3} style={[
                            styles.image3,
                            {
                                top: topAnim,
                            }
                    ...
                    <Animated.View style={[styles.box4]}>
                        <Animated.Image source={coin4} style={[
                            styles.image4,
                            {
                                top: topAnim,
                            }
